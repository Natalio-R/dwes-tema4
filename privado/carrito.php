        ...
        <div class="container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
            ...
            <ul class="nav nav-pills col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                if(isset($_SESSION['usuario'])) {
                    echo "<li class='nav-item'><a href='./tienda.php' class='nav-link px-2'>Tienda</a></li>";
                    echo "<li class='nav-item'><a href='./pagina_privada.php' class='nav-link px-2'>Página Privada</a></li>";
                }
                ?>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <ul class="dropdown-menu text-small px-2" style="">
                        ...
                        if(isset($_SESSION['usuario'])) {
                            ...
                            echo "<a href='./logout.php' class='btn btn-outline-danger w-100'><i class='bi bi-box-arrow-right'></i> Cerrar Sesión</a>";
                            } else {
    ...
    <div class="container">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <?php
                if(isset($_SESSION['usuario'])) {
                    echo "<li class='nav-item'><a href='./tienda.php' class='nav-link px-2 text-muted'>Tienda</a></li>";
                    echo "<li class='nav-item'><a href='./pagina_privada.php' class='nav-link px-2 text-muted'>Página Privada</a></li>";
                }
                ?>

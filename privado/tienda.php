...
<body>
    ...
    <header class="mb-4 border-bottom">
        <div class="container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
            ...
            <ul class="nav nav-pills col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li class="nav-item"><a href="./tienda.php" class="nav-link active px-2">Tienda</a></li>
                <li class="nav-item"><a href="./pagina_privada.php" class="nav-link px-2">Página Privada</a></li>
    ...
    <main class="container">
        ...
        if ($_SESSION && isset($productoNuevo)) {
            echo "<p class='alert alert-secondary' role='alert'>Se ha añadido un nuevo producto | " . array_key_first($productoNuevo) . "(" . $productoNuevo[array_key_first($productoNuevo)] .")</p>";
        }
        ?>
        <div class="section d-flex flex-column align-items-center">
            <h2 class="h2 mt-4">Añadir un producto nuevo</h2>
            <form action="tienda.php" method="post" style="width:350px">
                <div class="mb-3">

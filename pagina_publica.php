...
<body>
    ...
    <header class="mb-4 border-bottom">
        <div class="container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
            ...
            <ul class="nav nav-pills col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                ?>
                <li class="nav-item"><a href="./pagina_publica.php" class="nav-link active px-2">Página Pública</a></li>
            </ul>
    ...
    <div class="px-4 py-5 my-5 text-center">
        <h1 class="display-5 fw-bold">Página Pública</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Esta es la página publica donde todos los usuarios puede acceder, estén logueados o no.</p>
        </div>
    </div>
    <!-- /Main -->
